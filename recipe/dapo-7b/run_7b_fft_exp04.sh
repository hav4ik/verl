...
exp_name='sft7b-v6-dapo-fft-exp04'
adv_estimator=grpo
kl_coef=0.0
kl_loss_coef=0.0
clip_ratio_low=0.2
...
max_packed_length=$((1024 * 24))  # For sequence packing
...
VLLM_USE_V1=1 python3 -m verl.trainer.main_ppo \
    ...
    +actor_rollout_ref.actor.fsdp_config.wrap_policy.transformer_layer_cls_to_wrap=[Qwen2DecoderLayer,Qwen2Attention,LigerSwiGLUMLP] \
