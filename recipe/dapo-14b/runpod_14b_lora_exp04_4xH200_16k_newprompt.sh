...
MODEL_PATH=${MODEL_PATH:-"${KAGGLEHUB_CACHE}/models/xyzdivergence/aimo-sft-14b/Transformers/default/13"}
CKPTS_DIR=${CKPTS_DIR:-"${RAY_DATA_HOME}/ckpts/${project_name}/${exp_name}"}
TRAIN_FILE=${TRAIN_FILE:-"${KAGGLEHUB_CACHE}/datasets/chankhavu/verl-train-grpo-newprompt/versions/1/verl-train-v01-x10-newprompt.parquet"}
TEST_FILE=${TEST_FILE:-"${KAGGLEHUB_CACHE}/datasets/chankhavu/verl-train-grpo-newprompt/versions/1/verl-valid-40-probs-x8-newprompt.parquet"}
